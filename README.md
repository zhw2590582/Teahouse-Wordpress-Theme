...
12.因为考虑到文章的特色图较大，所以增加了利用自定义栏目的方式插入外链图片，节省空间之余还可以优化加载速度。这个和插入音乐外链同一做法，首先写文章时选择类型为“标准”，然后勾选“显示选项”里面的“自定义栏目”，在出现的“自定义栏目”里，点击“输入新栏目”，名称区域填入“picture”，值区域输入图片的路径即可。
